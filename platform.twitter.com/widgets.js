    ...
    (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init) ||
      (function (t) {
        ...
        function (t, e, n) {
          var r = n(16),
            i =
              /(?:^|(?:https?:)?\/\/(?:www\.)?(?:x|twitter)\.com(?::\d+)?(?:\/intent\/(?:follow|user)\/?\?screen_name=|(?:\/#!)?\/))@?([\w]+)(?:\?|&|$)/i,
            o =
              /(?:^|(?:https?:)?\/\/(?:www\.)?(?:x|twitter)\.com(?::\d+)?\/(?:#!\/)?[\w_]+\/status(?:es)?\/)(\d+)/i,
            s = /^http(s?):\/\/(\w+\.)*(?:x|twitter)\.com([:/]|$)/i,
            a = /^http(s?):\/\/(ton|pbs)\.twimg\.com/,
            u = /^#?([^.,<>!\s/#\-()'"]+)$/,
            c = /(?:x|twitter)\.com(?::\d{2,4})?\/intent\/(\w+)/,
            d =
              /^https?:\/\/(?:www\.)?(?:x|twitter)\.com\/\w+\/timelines\/(\d+)/i,
            f = /^https?:\/\/(?:www\.)?(?:x|twitter)\.com\/i\/moments\/(\d+)/i,
            l =
              /^https?:\/\/(?:www\.)?(?:x|twitter)\.com\/(\w+)\/(?:likes|favorites)/i,
            h =
              /^https?:\/\/(?:www\.)?(?:x|twitter)\.com\/(\w+)\/lists\/([\w-%]+)/i,
            p = /^https?:\/\/(?:www\.)?(?:x|twitter)\.com\/i\/live\/(\d+)/i,
            m = /^https?:\/\/syndication\.(?:x|twitter)\.com\/settings/i,
            v =
              /^https?:\/\/(localhost|platform)\.(?:x|twitter)\.com(?::\d+)?\/widgets\/widget_iframe\.(.+)/i,
            g = /^https?:\/\/(?:www\.)?(?:x|twitter)\.com\/search\?q=(\w+)/i;
          function w(t) {
        ...
        function (t, e, n) {
          var r = n(3),
            ...
            a = n(14);
          t.exports = function (t, e, n) {
            return new i(s, o, a.BROADCAST, t, e, n, {
        ...
        function (t) {
          t.exports = {
            tweetButtonHtmlPath:
              "/widgets/tweet_button.1227a5674072e080ffb1ba14ac0c1079.{{lang}}.html",
            followButtonHtmlPath:
              "/widgets/follow_button.1227a5674072e080ffb1ba14ac0c1079.{{lang}}.html",
            hubHtmlPath: "/widgets/hub.html",
            widgetIframeHtmlPath:
              "/widgets/widget_iframe.1227a5674072e080ffb1ba14ac0c1079.html",
        ...
        function (t, e, n) {
          var r = n(0),
            ...
            o = n(12)(),
            s = n(60),
            a = "blockquote.twitter-broadcast";
          t.exports = function (t, e) {
            return o(t, a).map(function (t) {
              return s(
                (function (t) {
                  var e = i(t),
                    n = t.getAttribute("data-broadcast-id");

  ...
  [7],
  {
        ...
        t.params({ partner: { fallback: c(d.val, d, "partner") } }),
          ...
          t.define("scribeInteraction", function (t, e, r) {
            ...
            return (
              (i.action = t.type),
              "url" === i.element &&
                (i.element = n.clickEventElement(t.target)),
              this.scribe(i, e, r)
            );
          });
      };
    ...
    174: function (t, e, r) {
      var i = r(3),
        ...
        a = [
          ...
          "https://cdn.syndication.twitter.com",
          "https://syndication.twimg.com",
          "https://cdn.syndication.twimg.com",
          "https://syndication-o.twitter.com",
          "https://syndication-o.twimg.com",
        ],
        s = !1,
        o = function (t) {
      ...
      t.exports = n.couple(r(166), function (t) {
          ...
          t.before("hydrate", function () {
            i.addEventListener &&
              i.addEventListener(
                ...
                this.scribeSecurityPolicyViolation.bind(this)
              );
          });
      });
    },
      ...
      t.exports = function (t) {
        t.params({
          ...
          t.before("render", function () {
            ...
            return this.styleSandboxWrapper && this._sandboxWrapperEl
    ...
    202: function (t, e, r) {
      var i = r(6),
        ...
        m = "X Post",
        b = n.version;
      t.exports = s.couple(r(166), r(171), function (t) {
        t.params(p),
          ...
          t.override("render", function () {
            ...
            return f.getHorizonSettings().then(function (e) {
              var r = t.getUrlParams(e.features, e.sessionId),
                ...
                s = u.url(n, r);
              return (
                h(e.features, t.params.tweetId, e.sessionId),
                t.sandbox.setWaitToSwapUntilRendered(!0),
                i.all([
                  t.sandbox.setTitle(m),
                  t.styleSandboxWrapper({
                    display: "flex",
                  ...
                  t.sandbox.styleSelf({ display: "block", flexGrow: "1" }),
    ...
    203: function (t, e, r) {
      var i = r(173),
        ...
        u = {
          ...
          mediaMaxWidth: { fallback: void 0, validate: i, transform: i },
    ...
    204: function (t, e, r) {
      ...
      t.exports = function (t, e, r) {
        ...
        t &&
          (s = t[a]) &&
          s.bucket &&
          i(a, s.bucket, s.version, n.formatHorizonTweetData(e), r);
      };
    },
    205: function (t, e, r) {
      var i = r(72);
      t.exports = function (t, e, r, n, a) {
        var s = {
          ...
          o = { experiment_key: t, bucket: e, version: r, data: n },
          c = { session_id: a };
    ...
    82: function (t, e, r) {
      var i = r(165);
      t.exports = i.build([r(202), r(175), r(174)]);
    },
  },
]);

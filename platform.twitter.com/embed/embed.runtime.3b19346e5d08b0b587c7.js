  ...
  (b.m = i),
    ...
    (b.O = (n, d, a, o) => {
      if (!d) {
        ...
        for (t = 0; t < e.length; t++) {
          for (var [d, a, o] = e[t], r = !0, f = 0; f < d.length; f++)
            (!1 & o || i >= o) && Object.keys(b.O).every((e) => b.O[e](d[f]))
              ? d.splice(f--, 1)
              : ((r = !1), o < i && (i = o));
          if (r) {
            e.splice(t--, 1);
    ...
    (b.l = (e, n, d, i) => {
      if (a[e]) a[e].push(n);
        ...
        if (void 0 !== d)
          for (
            var c = document.getElementsByTagName("script"), t = 0;
            t < c.length;
            t++
          ) {
            var s = c[t];
    ...
    (() => {
      ...
      var n = (n, d) => {
          ...
          for (n && n(d); c < i.length; c++)
            (o = i[c]), b.o(e, o) && e[o] && e[o][0](), (e[o] = 0);
          return b.O(t);
        },
